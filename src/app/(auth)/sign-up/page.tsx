    ...
    <div className="flex justify-center items-center min-h-screen bg-black">
      ...
      <div className="relative w-full max-w-md p-8 space-y-6 bg-white/5 border border-white/10 rounded-2xl shadow-2xl backdrop-blur-sm">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-white/50 text-sm">Create an account to start detecting deepfakes</p>
        </div>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  />
                  {isCheckingUsername && (
                    <Loader2 className="h-4 w-4 mt-1 animate-spin text-white/40" />
                  )}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Input
                    ...
                    className="bg-white/5 border-white/10 text-white placeholder:text-white/20 focus:border-blue-500"
                  />
                  <p className="text-white/30 text-xs">We'll send you a verification code</p>
                  <FormMessage />
                </FormItem>
              )}
            />
